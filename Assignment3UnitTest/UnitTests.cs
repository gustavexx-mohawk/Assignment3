/*
  ...
  Purpose: To test the methods of the health care server application.
...
{
    /// <summary>
    /// This class contains unit tests to test the health care server application.
    /// </summary>
    [TestClass]
    public class UnitTests : ControllerBase
    {
        ...
        /// <summary>
        /// Tests the Immunization Controller PostImmunization method, retrieving the status code. 
        /// </summary>
        /// <returns>Task that executes asynchronously.</returns>
        [TestMethod]
        ...
        /// <summary>
        /// Tests the Immunization Controller PostOrganization method, retrieving the status code. 
        /// </summary>
        /// <returns>Task that executes asynchronously.</returns>
        [TestMethod]
        ...
        /// <summary>
        /// Tests the Patient Controller PostPatient method, retrieving the status code. 
        /// </summary>
        /// <returns>Task that executes asynchronously.</returns>
        [TestMethod]
        ...
        /// <summary>
        /// Tests the Provider Controller PostProvider method, retrieving the status code. 
        /// </summary>
        /// <returns></returns>
        [TestMethod]
