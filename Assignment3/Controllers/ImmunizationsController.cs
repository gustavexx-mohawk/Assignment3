/*
  ...
  Purpose: A controller for Immunization that determines what response to send back to a user when an HTTP request is made.
...
{
    /// <summary>
    /// This class represents a controller for Immunization that determines what response to send back to a user when an HTTP request is made.
    /// </summary>
    [Route("/Immunization")]
    [ApiController]
